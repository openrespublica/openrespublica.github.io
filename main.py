...
# Use a flexible environment variable with a fallback
PORTAL_URL = os.getenv("ORP_PUBLIC_PORTAL", "https://cloth-anniversary-please-trusted.trycloudflare.com/verify.html")
GITHUB_PORTAL = PORTAL_URL
